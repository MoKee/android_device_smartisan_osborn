...
public class MKExtTelephony extends IExtTelephony.Stub {
    ...
    private static MKExtTelephony sInstance;
    ...
    public static MKExtTelephony getInstance() {
        if (sInstance == null) {
            sInstance = new MKExtTelephony();
        }

        return sInstance;
    }

    private MKExtTelephony() {
